...
<asp:Content ID="Content2" ContentPlaceHolderID="MainTemplate" runat="server">
    <div data-role="content">
        <div class="container">
            <div class="jumbotron signUpFormHighLight">
                <table class="table ui-responsive">
                    <tr>
                        <th></th>
                        <th>Member Name</th>
                    ...
                    <tr>
                        <td>
                            <img src="Resources/images/amitesh.jpeg" width="100" height="125" /></td>
                        <td>Amitesh Jain</td>
                        <td>
                            <ul>
                    ...
                    <tr>
                        <td>
                            <img src="Resources/images/kaveh.jpg" width="100" height="125" /></td>
                        <td>Kaveh Arvand</td>
                        <td>
                            <ul>
                                <li>IT graduate Student at ISU</li>
                    ...
                    <tr>
                        <td>
                            <img src="Resources/images/harshit.jpg" width="100" height="125" /></td>
