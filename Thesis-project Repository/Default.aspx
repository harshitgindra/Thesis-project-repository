        ...
        <div class="container" id="mainpage">
            <div class="navbar navbar-fixed-top">
                <div class="visible-sm pager">
                    <img src="Resources/images/logo.jpg" alt="Your Logo" />
                </div>
                        ...
                        <div class="auto-style1">
                            ...
                            <table>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RequiredFieldValidator ControlToValidate="signUpUsername" ID="RequiredFieldValidator4" runat="server" ErrorMessage="UserName is Required"></asp:RequiredFieldValidator>
                                    </td>
                                    <td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator15" runat="server" ErrorMessage="Password is Required"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Confirm Password:
                                    ...
                                    <td>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator16" runat="server" ErrorMessage="Confirm Password is Required"></asp:RequiredFieldValidator>
                                    </td>
                                    <td>
                                         <asp:CompareValidator ControlToValidate="signUpPassword2" ControlToCompare="signUpPassword" ID="CompareValidator1" runat="server" ErrorMessage="Password and Confirm Password Must Match"></asp:CompareValidator>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                         <asp:RequiredFieldValidator ControlToValidate="secques" ID="RequiredFieldValidator5" runat="server" ErrorMessage="Security Question is Required"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                         <asp:RequiredFieldValidator ControlToValidate="secans" ID="RequiredFieldValidator6" runat="server" ErrorMessage="Security Answer is Required"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Phone Number</td>
                                    ...
                                    <td>
                                         <asp:RequiredFieldValidator ControlToValidate="phoneNumber" ID="RequiredFieldValidator7" runat="server" ErrorMessage="Phone Number is Required"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Provider</td>
                                    ...
                                    <td>
                                        <asp:RequiredFieldValidator ControlToValidate="ntwrkprovider" ID="RequiredFieldValidator8" runat="server" ErrorMessage="Provider is Required"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:RequiredFieldValidator ControlToValidate="accType" ID="RequiredFieldValidator9" runat="server" ErrorMessage="Account Type is Required"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                        ...
                        <div class="defaultviews">
                            <table>
                                <tr>
                                    ...
                                    <td>
                                        <asp:RequiredFieldValidator ControlToValidate="forgotEmailId" ID="RequiredFieldValidator10" runat="server" ErrorMessage="UserID is Required"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Account Type:
                                    ...
                                    <td>
                                        <asp:RequiredFieldValidator ControlToValidate="FpAccntType" ID="RequiredFieldValidator11" runat="server" ErrorMessage="Account Type is Required"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Retrievel Method:
                                    ...
                                    <td>
                                        <asp:RequiredFieldValidator ControlToValidate="retrievelMethodRadioList" ID="RequiredFieldValidator12" runat="server" ErrorMessage="Retrivel Method is Required"></asp:RequiredFieldValidator>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                    ...
                    <div class="defaultviews container">
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                     <asp:RequiredFieldValidator ControlToValidate="NewPassword" ID="RequiredFieldValidator13" runat="server" ErrorMessage="New Password Required"></asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>Confirm Password:
                                ...
                                <td>
                                    <asp:TextBox ID="CnfrmPassword" runat="server" TextMode="Password"></asp:TextBox></td>
                                <td>
                                    <asp:RequiredFieldValidator ControlToValidate="CnfrmPassword" ID="RequiredFieldValidator14" runat="server" ErrorMessage="Confirm Password is Required"></asp:RequiredFieldValidator>
                                   </td>
                                <td>
                                     <asp:CompareValidator ControlToValidate="CnfrmPassword" ControlToCompare="NewPassword" ID="CompareValidator2" runat="server" ErrorMessage="Password and Confirm Password Must Match"></asp:CompareValidator>
                                </td>
                            </tr>
                            <tr>
                                <td>
            ...
            <footer class="footer" >
                <div class="container">
                    ...
                    <h6>&copy Amitesh, Kaveh, Harshit</h6>
                </div>
            </footer>
        </div>
