<%@ Page Title="" Language="C#" MasterPageFile="~/Student.Master" AutoEventWireup="true" CodeBehind="StudentPreliminaryProject.aspx.cs" Inherits="Thesis_project_Repository.WebForm4" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="student" runat="server">
    ...
    <table>
        ...
        <tr>
            <td>Live Link: </td>
            <td>
                <asp:TextBox ID="livelink" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td>Keywords: </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:FileUpload ID="screencasts" runat="server" /></td>
        </tr>
        <tr>
            <td>Committee Chair: </td>
            <td>
                <asp:TextBox ID="committeeChair" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td>Committee Member: </td>
            <td>
                <asp:TextBox ID="committeemember" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
            <td>Graduate Advisor: </td>
            <td>
                <asp:TextBox ID="graduateAdvisor" runat="server"></asp:TextBox></td>
        </tr>
        <tr>
